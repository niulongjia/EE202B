...
#read occupancy csv
df_occupancy1=pd.read_csv(occupancy_fname_suffix + "05_summer.csv")
df_occupancy2=pd.read_csv(occupancy_fname_suffix + "05_winter.csv")
...
for i in range(2,len(df_occupancy1)):
    ...
    print("parsing:" + date_num)
    #open the file
    house_sm_fname="../house#05/05_sm_csv/" + date_num + ".csv"
    if os.path.isfile(house_sm_fname)==True:
        df_sm=pd.read_csv(house_sm_fname,
                          names=['powerallphases',
                                 'powerl1',
...
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=["unoccupied", "Occupied"], title='Use house#02 Random Forest Model to predict house#05')
# Plot normalized confusion matrix
plt.figure()
plot_confusion_matrix(cnf_matrix, classes=["unoccupied", "Occupied"], normalize=True, title='Normalized confusion matrix of RandomForest Model (Use house#02 Random Forest Model to predict house#05)')
