# -*- coding: utf-8 -*-
"""
Created on Sun Feb 12 22:29:17 2017
...
plug_fname_suffix="../house#03/03_plugs_csv/"
df_read=pd.read_csv(occupancy_fname_suffix + "03_winter.csv")
...
if os.path.isfile(house1_plug2_fname)==True:
    ...
    row_house1_plug2.plot(grid=True,legend=True,label='Freezer', color='r',linewidth=1)
...
if os.path.isfile(house1_plug4_fname)==True:
    ...
    row_house1_plug4.plot(grid=True,legend=True,label='PC', color='r',linewidth=1)
...
house1_plug6_fname= plug_fname_suffix + "07/" + date_num + ".csv"
if os.path.isfile(house1_plug6_fname)==True:
    ax6 = plt.subplot(817)
    df_house1_plug6 = pd.read_csv(house1_plug6_fname,names=['power_consumption'])
    row_house1_plug6=df_house1_plug6.iloc[:,0]    
