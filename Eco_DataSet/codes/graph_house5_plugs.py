# -*- coding: utf-8 -*-
"""
Created on Sun Feb 12 22:57:29 2017
...
occupancy_fname_suffix="../house#05/05_occupancy_csv/"
plug_fname_suffix="../house#05/05_plugs_csv/"
df_read=pd.read_csv(occupancy_fname_suffix + "05_summer.csv")
...
if os.path.isfile(plug2_fname)==True:
    ...
    row_house1_plug2.plot(grid=True,legend=True,label='Coffee', color='r',linewidth=1)
...
if os.path.isfile(plug3_fname)==True:
    ...
    row_house1_plug3.plot(grid=True,legend=True,label='Fountain', color='r',linewidth=1)
...
if os.path.isfile(plug4_fname)==True:
    ...
    row_house1_plug4.plot(grid=True,legend=True,label='Microwave', color='r',linewidth=1)
...
if os.path.isfile(plug5_fname)==True:
    ...
    row_house1_plug5.plot(grid=True,legend=True,label='Fridge', color='r',linewidth=1)
...
if os.path.isfile(plug6_fname)==True:
    ...
    df_house1_plug6 = pd.read_csv(plug6_fname,names=['power_consumption'])
    row_house1_plug6=df_house1_plug6.iloc[:,0]    
    row_house1_plug6.plot(grid=True,legend=True,label='Kettle', color='r',linewidth=1)
    ax6.xaxis.set_ticklabels([]) # hide tick text while keeping grid lines
#    ax6.set_xlabel('Time Elapsed')
#    ax6.set_ylabel('Power Consumption')
